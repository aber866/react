...
var PokeApp = (function (_React$Component) {
	...
	_createClass(PokeApp, [{
		...
		value: function onGrowl(name) {
			//Queremos que se ejecute cada vez que se haga click. para eso se pasa como atributo a Poketable
			var text = name + ', ' + name + '!';
		...
		value: function render() {
			...
			//Se le pasa la funcion para abajo con props, la del ongrowl
...
var PokeRow = (function (_React$Component) {
	...
	_createClass(PokeRow, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				'li',
				{ className: 'row', onClick: this.onClick.bind(this) },
            ...
            return _react2['default'].createElement(
                ...
                this.props.pokemons.map(function (pokemon) {
                    return _react2['default'].createElement(_PokeRow2['default'], {
                        ...
                        growl: _this.props.onGrowl }); //Funcion que se le pasa en pokeapp
                })
            );
        }
    }]);
